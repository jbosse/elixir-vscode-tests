...
suite('Command Test Suite', () => {
  test("runFile will send the command to the terminal", () => {
    ...
    assert.strictEqual("mox test my_file_name.something", actualCommand);
  });
  ...
  test("runDescribe will send the command to the terminal", () => {
    ...
    assert.strictEqual("mix test my_file_name.something --name /some.rando.m.test..../", actualCommand);
  });
  ...
  test("runTest will send the command to the terminal", () => {
    ...
    assert.strictEqual(`mix test my_file_name.something:${index + 1}`, actualCommand);
  });
  ...
  test("command will create a terminal when none exists", () => {
    ...
    assert.strictEqual(`Elixir Tests`, terminalName);
  ...
  test("will run for the file", () => {
    ...
    assert.strictEqual("mix test my_file_name.something", sendTexts[1]);
  });
  ...
  test("will run for the describe", () => {
    ...
    assert.strictEqual("mix test my_file_name.something --name /some.rando.m.test..../", sendTexts[1]);
  });
  ...
  test("will run for the test", () => {
    ...
    assert.strictEqual(`mix test my_file_name.something:${index + 1}`, sendTexts[1]);
  });
